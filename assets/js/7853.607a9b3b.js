"use strict";
(self["webpackChunkwebsite"] = self["webpackChunkwebsite"] || []).push([[7853],{
...
var prism = __webpack_require__(52349);
...
// extracted by mini-css-extract-plugin
/* harmony default export */ var styles_module = ({"codeBlockContainer":"codeBlockContainer_8r9j","codeBlockContent":"codeBlockContent_6g8O","codeBlockTitle":"codeBlockTitle_j2Dn","codeBlock":"codeBlock_U6z7","copyButton":"copyButton_ycDu","codeBlockLines":"codeBlockLines_qR4p"});
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function CodeBlock(_ref){var _parseLanguage;var children=_ref.children,blockClassName=_ref.className,metastring=_ref.metastring,title=_ref.title;var _useThemeConfig=(0,lib/* useThemeConfig */.LU)(),prism=_useThemeConfig.prism;var _useState=(0,react.useState)(false),showCopied=_useState[0],setShowCopied=_useState[1];var _useState2=(0,react.useState)(false),mounted=_useState2[0],setMounted=_useState2[1];// The Prism theme on SSR is always the default theme but the site theme
...
// extracted by mini-css-extract-plugin
/* harmony default export */ var Details_styles_module = ({"details":"details_4nRH"});
